        ...
        script 
{
   docker.withRegistry('https://docker.afaqy.sa', 'afaqy-hub') {	
    ...
    docker info
    docker pull afaqyco/java/avl-web-notifier-stage-2.14.18:latest
   docker container run \
    ...
    --name web-notifier \
    -v /afaqylogs/avlservice/web-notifier:/workdir/logs -v /var/run/docker.sock:/var/run/docker.sock docker.afaqy.sa/java/avl-web-notifier-stage-2.14.18:latest 
